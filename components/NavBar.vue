<template>
  <!-- ========== HEADER ========== -->
  <header
    class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full bg-white text-sm py-3 md:py-0">
    <nav
        ...
        <div
          ...
          <div
            ...
            <div
              ...
              <a
                class="font-medium text-gray-500 hover:text-gray-400 py-3 md:py-6"
                href="#">
                Company
              </a>
                ...
                <div
                  ...
                  <div class="md:grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div class="flex flex-col mx-1 md:mx-0">
                      <a
                        class="group flex gap-x-5 hover:bg-gray-100 rounded-lg p-4"
                        href="#">
                        <svg
                    ...
                    <div class="flex flex-col pt-4 md:pt-0 mx-1 md:mx-0">
                      ...
                      <!-- Link -->
                      <a
                        class="group mt-2 p-3 flex gap-x-5 items-center rounded-xl hover:bg-gray-100"
                        href="#">
                        <img
